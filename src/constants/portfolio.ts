...
export type Project = {
  ...
  featured: boolean;
  color: string;
  visualType: "workflow" | "strategy" | "model" | "research" | "product";
  href?: string;
  detailTitle?: string;
  subtitle?: string;
  workflow?: string[];
...
export const projects: Project[] = [
  ...
  { number: "07", slug: "pine-wilt-identification", title: "Pine Wilt Disease Identification", category: "Computer Vision", description: "A drone-image recognition system using Faster R-CNN and YOLO to identify pine wilt disease.", tags: ["YOLO", "Faster R-CNN", "Computer Vision", "Python"], result: "98% accuracy", featured: false, color: "#6B8A63", visualType: "research" },
];
